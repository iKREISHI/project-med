    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('planning', 'планирование'), ('confirmation', 'подтверждение'), ('отмена', 'cancellation')], max_length=20, verbose_name='Статус')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('org_signature', models.JSONField(blank=True, null=True, verbose_name='Организационная подпись')),
